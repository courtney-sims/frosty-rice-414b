...
```
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-rice-414b
```

A live public deployment of this template is available at [https://frosty-rice-414b.templates.workers.dev](https://frosty-rice-414b.templates.workers.dev)
